...
const { o } = __nccwpck_require__(828);
const { xml2js } = __nccwpck_require__(821);
...
const hasURL = () =>
{
	...
	{
		hasNative = "URL" in __nccwpck_require__(835);
	}
...
const {URL, URLSearchParams} = __nccwpck_require__( hasURL() ? 835 : 665 );
...
const urlencoded = __nccwpck_require__(461);
const URLSearchParams = __nccwpck_require__(590);
...
const Impl = __nccwpck_require__(29);
...
exports.URLSearchParams = __nccwpck_require__(590).interface;
...
exports.cannotHaveAUsernamePasswordPort = __nccwpck_require__(158).cannotHaveAUsernamePasswordPort;

exports.percentDecode = __nccwpck_require__(461).percentDecode;
...
const infra = __nccwpck_require__(207);
const { percentEncode, percentDecode } = __nccwpck_require__(461);
...
const { isASCIIHex } = __nccwpck_require__(207);
